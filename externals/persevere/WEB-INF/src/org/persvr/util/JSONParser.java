...
public class JSONParser {
    ...
    private static final InternalToken OBJECT_END = new InternalToken();
    private static final InternalToken ARRAY_END = new InternalToken();
    private static final InternalToken COLON = new InternalToken();
    private static final InternalToken COMMA = new InternalToken();
    private static final InternalToken PARANTHESIS_END = new InternalToken();
    ...
    private static InternalToken KEYWORD_SYMBOL = new InternalToken();
    ...
    public class JSONException extends RuntimeException{
		public JSONException(String message) {
			super(message + " on line " + getLineNumber() + " and column " + column);
		}
    } 
        ...
        switch (ch) {
            ...
            default:
                ...
                if (Character.isDigit(c) || c == '-') {
                	...
                	else if ((globalValue = GlobalData.getGlobalScope().get((String) token, GlobalData.getGlobalScope())) instanceof IdFunctionObject || globalValue instanceof PersistableClass){
                		return globalValue;
                	}
                	else
                		return token;
    ...
    private Object number() {
        ...
        try {
        	...
        	throw new JSONException("Error parsing number " + e.getMessage());
        }
    }
    ...
    private Object string(char start) {
        buf.setLength(0);
        while (c != start) {
